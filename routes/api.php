...
Route::get('/area', [AreasController::class], 'get');
Route::get('/genre', [GenresController::class], 'get');
Route::get('/shop_name',[ShopsController::class], 'get');
Route::get('/shop', [ImagesController::class], 'get');
